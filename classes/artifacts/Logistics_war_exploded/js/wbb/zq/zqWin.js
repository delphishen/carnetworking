...
Ext.zq.form = Ext.extend(Ext.FormPanel, {
    constructor : function(app) {
        ...
        Ext.zq.form.superclass.constructor.call(this, {
            region : 'center',
            labelWidth : 60,
            baseCls : 'x-plain',
            autoScroll : true,
...
Ext.zq.win = Ext.extend(Ext.Window, {
    constructor : function(app) {
        this.app = app;
        this.form = new Ext.zq.form(this);
        Ext.zq.win.superclass.constructor.call(this, {
            width : 300,
            plain : true,
            showLock : true,
            modal : true,
