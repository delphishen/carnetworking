...
Ext.jq.grid = Ext.extend(Ext.grid.GridPanel, {
	...
	onModify : function(btn) {
		...
		win.form.getForm().findField('userId').setValue(this.jq.userId);
		win.form.getForm().findField('companyId').setValue(this.jq.companyId);
		win.form.getForm().findField('userName').setValue(this.jq.loginName);
		win.form.getForm().findField('company').setValue(this.jq.company);

        win.form.getForm().findField('fleetId').setValue(this.jq.fleetId);
        win.form.getForm().findField('fleetName').setValue(this.jq.fleetName);
...
var jqView = function() {
	...
	this.sortTree = new Ext.jqTree.tree(this);
