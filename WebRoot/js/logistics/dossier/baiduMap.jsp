...
<head>
    ...
    !--引入百度api-->
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=1.5&ak=crn2dXlX5VaD9R0X75uOyc1vMstWidWu"></script>


<body>
<!--百度地图容器-->
<div style="width:1133px;height:525px;border:#ccc solid 1px;" id="dituContent"></div>
</body>
