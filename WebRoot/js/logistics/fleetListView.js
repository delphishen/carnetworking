 ...
 * @return {}
 */
var fleetListView = function(params) {
	this.queryPanel = new Ext.dispatchList.queryPanel(this);
	this.fleetListTree = new Ext.fleetListTree.tree(this);
...
//	alert(params[0].isAdd);
	...
	return new Ext.Panel({
				id : 'fleetListView',// 标签页ID，必须与入口方法一致，用于判断标签页是否已经打开
				title : '服务平台管理',
				layout : 'border',
				items : [this.fleetListTree, {
							region : 'center',
							layout : 'border',
